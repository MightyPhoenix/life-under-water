  ...
  return (
    <>
      <button
        ...
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full max-w-xs ml-auto relative right-0 top-0"
      >
        Create New Post
      </button>
      <div className="flex flex-row flex-wrap px-auto py-auto">
        {feeds.map((feed, key) => {
